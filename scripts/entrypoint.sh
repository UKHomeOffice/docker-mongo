...
main_startup="${base_startup_command} --replSet ${MONGODB_REPLICA_SET_NAME} --bind_ip_all --sslMode requireSSL --clusterAuthMode x509 --sslPEMKeyFile ${MONGODB_SSL_SERVER_BUNDLE} --sslCAFile ${MONGODB_SSL_CA}"
